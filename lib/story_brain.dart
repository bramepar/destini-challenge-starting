...
class StoryBrain {
  ...
  int _storyNumber = 0;
  List<int> plan1 = [2,2,5,3,4,5];
  List<int> plan2 = [1,3,4,3,4,5];
  //List<Set<int>> storyPlan = [{2,1},{2,3},{5,4},{3,3},{4,4},{5,5}];
...
//DONE: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
 void nextStory({int choiceNumber}){
   ...
   print('Actual storyNumber: $_storyNumber');
   if (_storyNumber == 3 || _storyNumber == 4 || _storyNumber == 5) {
     restart();
   }else {
     switch (choiceNumber) {
       case 1 :
         _storyNumber = plan1[_storyNumber];
         break;
       case 2 :
         _storyNumber = plan2[_storyNumber];
         break;
     }
     print('New storyNumber: : $_storyNumber');
   }
 }
